...
class Stars(
    ...
    init {
        ...
        add(ScrollingBackground("layer1", layer1, Vector2(), width, height, Vector2(0.0f, 0.05f)))
        add(ScrollingBackground("layer2", layer2, Vector2(), width, height, Vector2(0.0f, 0.1f)))
    }
